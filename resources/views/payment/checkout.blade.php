    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-8">
        <div class="max-w-md w-full bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="bg-emerald-50 rounded-xl p-4 mb-8">
                ...
                <p class="text-3xl font-bold text-emerald-600">Rp {{ number_format($order->total, 0, ',', '.') }}</p>
            </div>
            ...
            <button 
                id="pay-button"
                class="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-3 rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed"
                disabled
            >
                Bayar Sekarang
            </button>
