    ...
    <div class="space-y-6">
        <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden p-6">
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <form method="GET" action="{{ route('admin.products.index') }}" class="mb-0">
                    <div class="flex gap-2">
                        <input id="search" name="search" type="text" value="{{ $search ?? '' }}" placeholder="Cari judul, kelas, mata pelajaran, publisher, atau SKU" class="rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200" />
